            ...
            {filteredQueue.map((entry) => (
              <article key={entry.id} className="k-card space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <button className="k-btn" onClick={() => void markStatus(entry.id, "ready")}>Mark Ready</button>
                  <button className="k-btn" onClick={() => void markStatus(entry.id, "briefed")}>Mark Briefed</button>
                  <button className="k-btn" onClick={() => void markStatus(entry.id, "entered")}>Mark Entered</button>
                  <button className="k-btn" onClick={() => void markStatus(entry.id, "denied")}>Deny</button>
                </div>
              </article>
            ))}
          </div>
